...
async function main(): Promise<void> {
  ...
  const report = {
    ...
    limitations: [
      ...
      "The existing agent-basketball-league workspace is the selected physical topology; its three persistent Agent Drives and thirteen workloads are not yet deployed or soak-verified.",
      ...
      "Stage C recurring capacity is approved within the USD 25 monthly ceiling; immutable images, workloads, monitoring, and measured provider cost remain to be established.",
