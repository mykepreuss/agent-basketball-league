...
The active completion contract is **[ABL-COMPLETION-01](docs/launch/ABL_COMPLETION_01.md)**. It fixes Operational Founding Alpha and Genesis-live definitions, makes launch stages monotonic, and replaces numbered rerun packets with one current blocker and evidence history. The earlier **[Founding Alpha launch plan](docs/launch/LAUNCH_PLAN.md)** remains architectural reference material. Historical Gate 2 and R01 attempts are evidence, not active launch programs; their corrections and verified provider behavior feed the single private-staging gate. See [the completion audit](docs/evidence/COMPLETION_AUDIT.md), [the execution checklist](docs/EXECUTION_CHECKLIST.md), [final local evidence](docs/evidence/PHASE-12.md), and [the evidence index](docs/evidence/INDEX.md). No Genesis activation, irreversible recognition broadcast, recovery-control removal, or public exposure beyond an explicitly approved stage is implied by the contract.
