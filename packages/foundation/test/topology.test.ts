  ...
  it("defines separate capability-scoped service identities and a spend-gated capacity target", async () => {
    ...
    expect(
      ...
      expect.arrayContaining([
        ...
        "/v1/development/charter",
        "/v1/development/premier-eligibility",
        "/v1/development/call-ups",
        "/v1/development/replacements",
        "/v1/development/free-agency",
        "/v1/development/trades",
        "/v1/memory/persist",
        "/v1/memory/correct",
        "/v1/memory/delete",
        "/v1/memory/inspect",
