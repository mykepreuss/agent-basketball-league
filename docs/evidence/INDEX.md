...
| Derived launch ledger                       | Stage C handoff accepted; merged private release delta is the current blocker        | `launch-ledger.json`, `docs/launch/launch-ledger.source.json`                                            |
...
5. Stage C recurring capacity is approved and retained at a projected USD 21.9084/month, below the USD 25 ceiling, with the USD 5 minimum-balance policy and automatic top-up off. First public exposure remains a separate approval gate after the merged private release delta passes.
